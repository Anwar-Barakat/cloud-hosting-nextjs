        ...
        <footer className="bg-gray-100">
            <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                    Experience reliable, scalable, and secure cloud hosting solutions designed to grow with your business.
                    Join thousands of satisfied customers and simplify your cloud management with our 24/7 support and 99.9% uptime guarantee.
                </p>
